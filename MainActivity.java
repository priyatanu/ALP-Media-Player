...
public class MainActivity extends ListActivity
   ...
   // public static int toastduration=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("BZA", "MainActivity" + "onCreate"  );
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        Toast.makeText(this, "Please Select Server to connect", Toast.LENGTH_LONG);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        Log.d("Holla", "MainActivity" + "onListItemClick"  );

        if ((l.getItemAtPosition(position)) instanceof DeviceModel) {
            Log.d("BZA", "MainActivity doing model stuff" + "onListItemClick"  );

            mCurrentDevice = (DeviceModel) (l.getItemAtPosition(position));
